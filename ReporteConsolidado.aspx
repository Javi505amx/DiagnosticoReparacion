<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteConsolidado.aspx.cs" Inherits="DiagnosticoReparacion.ReporteConsolidado" %>
...
<head runat="server">
    ...
    <title>Consolidado Diagnostico</title>
...
<body class="body-menu">
    <form id="form1" runat="server">
        <div class="header-menu">
            ...
            <h1>Consolidado Diagnosticos</h1>
        </div>
<%--        <div class="form-repa">
            ...
            <div class="card-body scrolling-table-container2">
                <asp:GridView ID="GridView12" HeaderStyle-CssClass="bg-secondary text-white" ShowHeaderWhenEmpty="true" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover table-condensed small-top-margin">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Diagnostico" DataField="Diagnostic" />
                        <asp:BoundField HeaderText="Locacion" DataField="Location" />
                        <asp:BoundField HeaderText="Fecha" DataField="DiagnosticDate" />
                        <asp:BoundField HeaderText="Commentarios" DataField="Comments" />
                    </Columns>
                </asp:GridView>
            </div>
        </div>
