...
<body class="body-menu">
    <form id="form1" runat="server">
        ...
        <div class="form-repa">
            ...
            <asp:TextBox ID="txtSerial" runat="server" ForeColor="#0079bc" AutoPostBack="false" Font-Size="150%" Style="text-transform: uppercase" AutoCompleteType="Disabled" OnTextChanged="txtSerial_TextChanged" ></asp:TextBox><br />
        ...
        <div class="container4 mx-auto">
            <div id="labels" class="labels">
                ...
                <asp:Label ID="Label3" runat="server" Text="Diagnostico:" Visible="false"></asp:Label><br />
            ...
            <div id="labelr" class="labelr">
                ...
                &nbsp;&nbsp;<asp:TextBox ID="txtLoc" runat="server" Text="" Visible="false" ></asp:TextBox><br />
            </div>
