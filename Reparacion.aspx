        ...
        <div class="container4 mx-auto">
            ...
            <div id="labelr" class="labelr">
                ...
                &nbsp;&nbsp;<asp:DropDownList runat="server" ID="ListValue" Visible="false" CssClass="mydropdownlist" AutoPostBack="true" Font-Size="Small">
                    ...
                    <asp:ListItem Value="FF0001" Text="FF0001-Falso Rechazo de equipo"></asp:ListItem>
                    <asp:ListItem Value="FF0002" Text="FF0002-Debugeo de fixture nuevo"></asp:ListItem>
                    <asp:ListItem Value="FF0002" Text="FF0003-Residuos de potting en cables"></asp:ListItem>
                    <asp:ListItem Value="FF0004" Text="FF0004-Falla en el equipo de diagnostico"></asp:ListItem>
                    <asp:ListItem Value="FF0005" Text="FF0005-Falso Rechazo operación"></asp:ListItem>
                    <asp:ListItem Value="FF0006" Text="FF0006-Falta de prueba OTP"></asp:ListItem>
                    <asp:ListItem Value="FFR001" Text="FF0005-Falso Rechazo de Equipo Output Current"></asp:ListItem>
                    <asp:ListItem Value="FF0008" Text="FF0008-Residuos de potting en conector"></asp:ListItem>
                ...
                &nbsp;&nbsp;<asp:TextBox ID="txtValue" runat="server" Text="" Visible="false"></asp:TextBox><br />
