...
{
    public partial class SalidaScrap : System.Web.UI.Page
    {
        ...
        protected void txtSerial_TextChanged(object sender, EventArgs e)
        {
            ...
            {   //SqlDataReader (WO, Model and Serial Number)
                ...
                SqlCommand sqlCommand = new SqlCommand("OutScrap", sqlConnection2)
                {
                    CommandType = CommandType.StoredProcedure
                };
                sqlConnection2.Open();
                ...
                if (rowsInserted == 1)
                {
                    ...
                    res.Text = "SALIDA SCRAP CORRECTAMENTE";
                ...
                else if (rowsInserted == 0)
                {
                    ...
                    res.Attributes.Add("role", "alert");
                    res.Text = "DRIVER no encontrado en scrap";
                ...
                else if (rowsInserted == 2)
                {
                    ...
                    res.Attributes.Add("role", "alert");
                    res.Text = "Driver salio de scrap";
                ...
                else if (rowsInserted == 9)
                {
                    res.Attributes.Add("class", "alert alert-warning");
                    res.Attributes.Add("role", "alert");
                    res.Text = "CONTACTE A IT";
                    res.ForeColor = System.Drawing.Color.Orange;
                    lblSN.Text = dataScan;
                    txtSerial.Text = "";
                    // txtCodeDefect.Text = "";
