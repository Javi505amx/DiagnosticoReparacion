<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultaReparaciones.aspx.cs" Inherits="DiagnosticoReparacion.ConsultaReparaciones" %>
...
<head runat="server">
    ...
    <title>Consulta Reparaciones</title>
            ...
            <div class="card-body scrolling-table-container">
                <asp:GridView ID="GridView12" HeaderStyle-CssClass="bg-secondary text-white" ShowHeaderWhenEmpty="true" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover table-condensed small-top-margin">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Reparacion" DataField="Repair" />
                        <asp:BoundField HeaderText="Usuario" DataField="UserScanOut" />
                        <asp:BoundField HeaderText="Fecha" DataField="ScanDateOut" />
                    </Columns>
                </asp:GridView>
            </div>
        </div>
