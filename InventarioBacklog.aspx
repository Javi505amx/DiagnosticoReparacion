<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InventarioBacklog.aspx.cs" Inherits="DiagnosticoReparacion.InventarioBacklog" %>
...
<head runat="server">
    ...
    <title>Inventario Backlog</title>
...
<%--        <div class="form-repa">
        ...
        <div class="card2">
            <div class="card-body scrolling-table-container2">
                <asp:GridView ID="GridView12"  HeaderStyle-CssClass="header FixedHeader text-white " ShowHeaderWhenEmpty="true" runat="server" AutoGenerateColumns="true" CssClass="table table-striped table-hover table-condensed small-top-margin" RowStyle-CssClass="rows text-center" DataSourceID="SqlDataSource1" AllowSorting="True" OnRowDataBound="GridView12_RowDataBound">
                   ...
                   <%-- <Columns>
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="PrimerIngreso" DataField="ScanDate" />
                        <asp:BoundField HeaderText="UltimoDiagnostico" DataField="DiagnosticDate" />
                        <asp:BoundField HeaderText="Dias" DataField="Days" />
                        <asp:BoundField HeaderText="StatusDays" DataField="StatusDays" />
                        <asp:BoundField HeaderText="Status" DataField="Status" />

                    </Columns>--%>
                </asp:GridView>
                <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:con %>' SelectCommand="GetBacklog" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
            </div>
        </div>
